...
public enum ErrorStatus {
    ...
    WEATHER_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "날씨 정보를 가져오는 중 오류가 발생했습니다."),
    WEATHER_CLIENT_ERROR(HttpStatus.BAD_REQUEST, "날씨 정보 요청에 오류가 발생했습니다."),
    WEATHER_DATA_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 지역의 날씨 정보를 찾을 수 없습니다."),
    WEATHER_CACHE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "날씨 정보 캐시 처리 중 오류가 발생했습니다."),
    WEATHER_API_KEY_ERROR(HttpStatus.UNAUTHORIZED, "날씨 API 키가 유효하지 않습니다.");
